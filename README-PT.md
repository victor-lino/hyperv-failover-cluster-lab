...
![Dashboard do Cluster](images/01-cluster-dashboard-storage_3.png)

**2. Estado Normal (VM no NODE01)**
Máquina virtual operando e acessível através do host primário (`NODE01`).
![VM Ativa no Node 01](images/03-vm-active-node01_5.jpg)
...
![Failover em Andamento](images/11-cluster-vm-unmonitored-node02_3.png)
...
![VM Migrada para Node 02](images/04-vm-migrated-node02_5.jpg)
...
![Retorno do Ping](images/05-ping-failover-validation_3.png)
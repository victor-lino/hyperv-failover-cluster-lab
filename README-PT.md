...
Máquina virtual operando e acessível através do host primário.
![VM Ativa no Node 01](images/03-vm-active-node01_2.jpg)
...
![VM Migrada para Node 02](images/04-vm-migrated-node02_2.jpg)

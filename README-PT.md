...
<p align="center">
  <img src="images/cover-architecture.png" alt="Arquitetura do Hyper-V Cluster" width="100%">
</p>
...
![Dashboard do Cluster](images/01-cluster-dashboard-storage_4.png)

**2. Estado Normal (VM no NODE01)**
Máquina virtual operando e acessível através do host primário (`NODE01`).
![VM Ativa no Node 01](images/03-vm-active-node01_6.jpg)
...
![Failover em Andamento](images/11-cluster-vm-unmonitored-node02_4.png)
...
![VM Migrada para Node 02](images/04-vm-migrated-node02_6.jpg)
...
![Retorno do Ping](images/05-ping-failover-validation_4.png)
...
<p align="center">
  <img src="images/cover-architecture.png" alt="Hyper-V Cluster Architecture" width="100%">
</p>
...
![Cluster Dashboard](images/01-cluster-dashboard-storage_3.png)

**2. Normal State (VM on NODE01)**
The virtual machine operating and accessible through the primary host (`NODE01`).
![VM Active on Node 01](images/03-vm-active-node01_5.jpg)
...
![Failover in Progress](images/11-cluster-vm-unmonitored-node02_3.png)
...
![VM Migrated to Node 02](images/04-vm-migrated-node02_5.jpg)
...
![Ping Return](images/05-ping-failover-validation_3.png)
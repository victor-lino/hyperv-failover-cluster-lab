...
The virtual machine operating and accessible through the primary host.
![VM Active on Node 01](images/03-vm-active-node01_2.jpg)
...
![VM Migrated to Node 02](images/04-vm-migrated-node02_2.jpg)
